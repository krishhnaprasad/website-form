...
class ResConfigSettings(models.TransientModel):
    ...
    def COLOR_ASSET_LIGHT_URL(self):
        return '/web_enterprise/static/src/scss/colors_light_picker.scss'
    ...
    def COLOR_ASSET_DARK_URL(self):
        return '/web_enterprise/static/src/scss/colors_dark_picker.scss'
    ...
    def COLOR_ASSET_THEME_LIGHT_URL(self):
        return '/web_enterprise/static/src/scss/colors_light.scss'
    ...
    def COLOR_ASSET_THEME_DARK_URL(self):
        return '/web_enterprise/static/src/scss/colors_dark.scss'
